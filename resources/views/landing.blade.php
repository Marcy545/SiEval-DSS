...
<body class="antialiased bg-white text-slate-900 overflow-x-hidden">
    ...
    <section class="bg-slate-950 pt-16 md:pt-24 pb-12 px-6 text-center text-white relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto relative z-10">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-3.5 max-w-md mx-auto sm:max-w-none mb-12 md:mb-16 px-4">
                <a href="/register" class="px-7 py-3 border border-slate-700 rounded-full font-bold text-sm hover:bg-slate-900 transition tracking-wide active:scale-98">
                    Laporan Banjir (Warga)
                </a>
                <a href="/login?role=kecamatan" class="px-7 py-3 bg-white text-slate-950 rounded-full font-bold text-sm hover:bg-slate-100 transition tracking-wide shadow-md active:scale-98">
            ...
            <div class="space-y-12">
                ...
                <div class="flex gap-5">
                    ...
                    <div class="space-y-1">
                        ...
                        <p class="text-slate-500 text-sm leading-relaxed">SiEval DSS akan menilai setiap laporan secara objektif berdasarkan tingkat kerusakan material, kondisi ekonomi, dan keberadaan kelompok rentan (lansia/bayi).</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                @php
                    $features = [
                        ...
                        ['n' => '2', 't' => 'Dashboard Banjir', 'd' => 'Ringkasan visual terintegrasi meliputi peringatan darurat evakuasi, grafik tinggi air, dan rekapitulasi kerugian.'],
    ...
    <section class="mx-4 md:mx-12 my-20 bg-slate-950 rounded-[40px] py-16 md:py-20 px-6 text-center text-white relative overflow-hidden">
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-3 max-w-xs mx-auto sm:max-w-none relative z-10 px-4">
            <a href="/register" class="px-7 py-3 border border-slate-700 hover:bg-slate-900 transition rounded-full font-bold text-sm tracking-wide active:scale-98">Laporan Banjir (Warga)</a>
            <a href="/login?role=kecamatan" class="px-7 py-3 bg-white text-slate-950 hover:bg-slate-100 transition rounded-full font-bold text-sm tracking-wide shadow-md active:scale-98">Lihat Dashboard (Kecamatan)</a>
        </div>
    </section>
    ...
    <div id="authModal" class="fixed inset-0 z-[100] hidden items-center justify-center bg-slate-950/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
        <div class="bg-white w-full max-w-2xl rounded-[32px] p-8 md:p-10 relative shadow-2xl border border-slate-100" onclick="event.stopPropagation()">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 md:grid-cols-2 md:gap-6">
                <a href="#" id="linkWarga" class="group border border-slate-200/80 rounded-2xl p-5 md:p-6 hover:border-blue-500 hover:bg-blue-50/40 transition-all duration-200 relative overflow-hidden flex flex-col justify-between">
                ...
                <a href="#" id="linkKecamatan" class="group border border-slate-200/80 rounded-2xl p-5 md:p-6 hover:border-blue-500 hover:bg-blue-50/40 transition-all duration-200 relative overflow-hidden flex flex-col justify-between">
                    <div class="relative z-10">
    ...
    <script>
        ...
        // 1. HAMBURGER MENU INTERACTION FOR MOBILE DEVICES
        ...
        // 2. MODAL CENTRAL AUTH FLOW CONTROL
